<nav class="navbar navbar-inverse visible-xs">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Oliveira</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li><a href="<?php echo URL; ?>controle-mandado/index">Mandados</a></li>
                <li><a href="<?php echo URL; ?>controle-anotacao/index">Anotações</a></li>
                <li><a href="<?php echo URL; ?>controle-fim/index">Finalidades</a></li>
                <li><a href="<?php echo URL; ?>controle-vara/index">Varas</a></li>
                <li><a href="<?php echo URL; ?>controle-rota/index">Rotas</a></li>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        if (!empty($_SESSION['foto'])):
                            ...
                            $foto = URL . "assets/imagens/adm/icone-geral.jpg";
                            echo "<img src='$foto' class='img-circle' height='50' width='50' alt='Avatar'>";
                        endif;
                        ?>
                    </div>
