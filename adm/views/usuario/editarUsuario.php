...
<div class="well">
    <div class="pull-right">
        ...
        <a href="<?php echo URL; ?>controle-usuario/apagar/<?php echo $valorForm['id']; ?>"><button type="button" class="btn btn-sm btn-danger" onclick="return confirm('Deseja mesmo apagar?');">Apagar</button></a>
    </div>
    <div class="page-header text-center">
        <h1>Formulário para Editar o Usuário</h1>
    </div>
    <H1></H1>
    <?php
