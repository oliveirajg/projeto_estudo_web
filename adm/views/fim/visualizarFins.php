<div class="well">
    <div class="pull-right">
        ...
        <a href="<?php echo URL; ?>controle-fim/editar/<?php echo $this->Dados[0]['id']; ?>"><button type="button" class="btn btn-sm btn-warning">Editar</button></a>
         <a href="<?php echo URL; ?>controle-fim/apagar/<?php echo $this->Dados[0]['id']; ?>"><button type="button" class="btn btn-sm btn-danger">Apagar</button></a>
    </div>
    <div class="page-header">
        <h1>Detalhes Finalidade</h1>
    </div>
    <?php
    ...
    if (!empty($this->Dados[0]['id'])):
        ...
        <dl class="dl-horizontal">
            ...
            <dt>Nome</dt>
            <dd><?php echo $this->Dados[0]['nome_fim']; ?></dd>
