...
class ModelsRecuperarSenha {
    ...
    private function criarEmailRecSenha() {
        ...
        $this->DadosRecSenha['mensagem'] .= "Você solicitou uma alteração de senha em COMAN/Iguatu-CE<br>";
        ...
        $this->DadosRecSenha['mensagem'] .= "Respeitosamente, Oliveira10474.com.br<br>";
    }
