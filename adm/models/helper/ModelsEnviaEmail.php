...
class ModelsEnviaEmail {
    ...
    private function setMail() {
        ...
        $this->RemetenteNome = "COMAN";
        //Inserir abaixo seu email de remetente
        $this->RemetenteEmail = "coman_iguatu@oliveira10474.com.br";
    ...
    private function configurarEmail() {
        ...
        $this->Mail->Host = 'oliveira10474.com.br';
        $this->Mail->Port = '465';
        $this->Mail->Username = 'coman_iguatu@oliveira10474.com.br';
